...
export let SearchService = function (options) {
  var self = this;
 ...
 * @param options : (object)
 */
export let AlgoliaSearch = function (options) {
 ...
 * @param options : (object)
 */
export let AzureSearch = function (options) {
  SearchService.apply(this, arguments);
  var self = this;
 ...
 * @param options : (object)
 */
export let BaiduSearch = function (options) {
  SearchService.apply(this, arguments);
  var self = this;
  var endpoint = "";
  self.addLogo('baidu');
